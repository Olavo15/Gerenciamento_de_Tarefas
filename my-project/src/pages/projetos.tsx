    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center">
                ...
                <button onClick={() => setAbriModalFormularioProjeto(true)} type="submit" className="bg-zinc-100 rounded-md flex gap-1 px-2 py-1 shadow-md">
                    Adicionar projeto
                ...
                <div>
                    ...
                    <div className='flex gap-2 flex-wrap'>
                        {projetosUsuario.map(projeto => (
                            <a href={`/projeto/${projeto.id}`} key={projeto.id} className='p-2 bg-zinc-100 rounded-md shadow-md w-72 border-l-[4px] border-purple-400'>
