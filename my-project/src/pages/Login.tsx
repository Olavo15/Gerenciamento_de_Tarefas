...
export default function Login(){
    ...
    return(
        <div className="flex items-center justify-center w-screen h-screen" >
            <form className="flex items-center justify-center px-4 py-10 bg-zinc-50 shadow-lg rounded-2xl w-fit flex-col gap-3" onSubmit={(e: FormEvent<HTMLFormElement>) => { e.preventDefault(); login(e); }}>
